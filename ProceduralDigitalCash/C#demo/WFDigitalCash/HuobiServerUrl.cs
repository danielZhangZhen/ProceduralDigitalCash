...
namespace WFDigitalCash
{
    ...
    {
        private static string doMain = "https://api.huobi.pro/";
        private static string market = $"{doMain}market";
        private static string transaction = $"{doMain}v1";
        ...
        //POST申请撤销一个订单请求
        public static string API_ORDERS_SUBMITCANCEL = " /v1/order/orders/{order-id}/submitcancel";
        //POST  批量撤销订单
        public static string API_ORDERS_BATCHCANCEL = "/v1/order/orders/batchcancel";
        //GET 查询某个订单详情
        public static string API_ORDERS_ORDERID = "/v1/order/orders/{order-id} ";
        //GET 查询某个订单的成交明细
        public static string API_ORDERS_ID_MATCHRESULTS = "/v1/order/orders/{order-id}/matchresults";
        //GET查询当前委托、历史委托
